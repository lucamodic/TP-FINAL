...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es el nombre del actor que interpreta a Tony Stark/Iron Man en el Universo Cinematográfico de Marvel?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Quién es la protagonista de la película "Mujer Maravilla" (2017), basada en el personaje de DC Comics?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál de los siguientes programas de televisión es un "reality show" de competencia culinaria?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Qué banda de rock liderada por Mick Jagger es conocida como "La banda de rock and roll más grande del mundo"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Quién es el creador de la exitosa franquicia de películas "Star Wars"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película de Pixar los personajes principales son juguetes que cobran vida cuando los humanos no los ven?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es la comedia de situación que presenta a un grupo de amigos que viven en Nueva York y se llama "The One Where..."?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Qué película musical de 1971 está basada en el libro de Lewis Carroll y sigue las aventuras de Alicia en un mundo mágico?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Quién es el actor que interpretó a James Bond en películas como "GoldenEye" y "Skyfall"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Qué director es conocido por películas como "El Laberinto del Fauno" y "El Laberinto del Pan"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película de ciencia ficción de 2010, dirigida por Christopher Nolan, los personajes viajan a través de los sueños?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Quién es la actriz que interpretó a Katniss Everdeen en la serie de películas "Los Juegos del Hambre"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es la película de Disney en la que un joven león llamado Simba debe enfrentar su destino como rey de la Sabana?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película de ciencia ficción de 1984, dirigida por James Cameron, un cyborg asesino viaja desde el futuro para matar a Sarah Connor?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es el nombre del personaje interpretado por Johnny Depp en la franquicia de películas "Piratas del Caribe"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película de 1973, dirigida por William Friedkin, dos detectives investigan una serie de asesinatos brutales en Nueva York?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es la actriz que interpretó a Hermione Granger en la serie de películas de "Harry Potter"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película un científico llamado Doc Brown construye una máquina del tiempo a partir de un DeLorean?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿Cuál es la banda de rock británica conocida por su álbum "The Wall" y canciones como "Another Brick in the Wall"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(1, '¿En qué película de animación un joven llamado Miguel viaja a la Tierra de los Muertos en el Día de los Muertos mexicano?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte que se juega en la Copa Davis?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte se utiliza una red separando a dos equipos, y el objetivo es pasar la pelota sobre la red y que toque el suelo en el campo contrario?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el único deporte en el que los jugadores pueden usar sus pies, excepto el portero?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte el jugador puede marcar puntos al encestar la pelota en el aro del equipo contrario?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los competidores deben nadar, andar en bicicleta y correr en una serie de etapas?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte que se juega con un mazo y una pelota en un campo con césped y se asocia con la realeza británica?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál de los siguientes deportes se juega en una cancha rectangular y se golpea una pelota contra una pared frontal?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los equipos compiten para tirar un disco de plástico en una canasta?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los competidores deben realizar una serie de ejercicios como salto de altura, lanzamiento de bala y carreras?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál de los siguientes deportes se juega en una cancha de hielo con piedras y escobas?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte se lucha cuerpo a cuerpo en un área circular y el objetivo es hacer que el oponente toque el suelo con la espalda?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los equipos compiten para tirar un objeto llamado "pelota" en una canasta?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte los competidores deben lanzar una pelota a alta velocidad y tratar de no ser golpeados por la misma?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los competidores usan un palo para golpear una pequeña bola en un hoyo en el menor número de golpes?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte los competidores deben derribar a sus oponentes con un balón de goma y evitar ser golpeados?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte en el que los competidores realizan acrobacias en una tabla que se desliza por la nieve?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál de los siguientes deportes se juega en un campo con un agujero y una bandera y el objetivo es golpear la pelota en el agujero en la menor cantidad de golpes?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿En qué deporte se utiliza una raqueta para golpear una pelota sobre una red en un campo rectangular?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cuál es el deporte de invierno en el que los competidores descienden por una pista de hielo a alta velocidad en un trineo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(2, '¿Cual fue la mayor cantidad de goles que recibio en un solo partido la seleccion de Brasil?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Quién pintó la famosa obra "La última cena"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de las siguientes pinturas es conocida por su representación de una noche estrellada sobre un pueblo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué movimiento artístico se caracteriza por la representación de escenas cotidianas y el uso de la luz natural?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Quién es el autor de la escultura "El Pensador"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de las siguientes corrientes artísticas se caracteriza por el uso de colores brillantes y formas geométricas?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué famoso artista pintó "La persistencia de la memoria", con relojes derretidos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de los siguientes artistas es conocido por sus pinturas de flores, especialmente los lirios de agua?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál es el nombre de la pintura que representa a una mujer sonriente con un fondo enigmático?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué movimiento artístico se caracteriza por la representación de la vida cotidiana en París, con escenas de cafés, bailes y teatros?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de las siguientes esculturas es conocida por su representación de un hombre desnudo sosteniendo una lanza?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Quién es el autor de la famosa pintura "El grito"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué movimiento artístico se caracteriza por la representación de objetos y figuras de manera fragmentada y en múltiples perspectivas?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de las siguientes pinturas representa un toro y un caballo en medio de una tormenta?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué artista es conocido por sus autorretratos, en los que a menudo se representa con una ceja unida?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué famoso pintor renacentista creó la obra "El nacimiento de Venus"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Cuál de las siguientes corrientes artísticas se caracteriza por la representación de escenas misteriosas y oníricas?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué movimiento artístico se desarrolló a principios del siglo XX y se caracteriza por la representación de objetos y figuras de manera abstracta?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Quién es el autor de la famosa pintura "Noche estrellada sobre el Ródano"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Qué escultor creó la famosa obra "El beso"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(3, '¿Quién es el pintor que se asocia con el estilo del "arte pop" y creó obras como "Latas de sopa Campbell"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el elemento químico más abundante en la Tierra?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la unidad básica de la materia que conserva las propiedades de un elemento químico?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso mediante el cual las plantas convierten la luz solar en energía química?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la fuerza que mantiene a los planetas en órbita alrededor del Sol?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la unidad básica del sistema nervioso que transmite señales eléctricas entre las células?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la partícula subatómica que tiene una carga positiva en el núcleo de un átomo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la capa de la atmósfera terrestre donde se produce la mayoría de los fenómenos meteorológicos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la teoría científica que describe el origen y la evolución del universo a partir de un solo punto en el espacio y el tiempo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso mediante el cual un organismo pasa por etapas de desarrollo desde la fertilización hasta la madurez?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la unidad básica de herencia genética que contiene información genética?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso mediante el cual las plantas obtienen agua y nutrientes del suelo a través de sus raíces?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la molécula que almacena y transmite información genética en los seres vivos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso mediante el cual el cuerpo convierte los alimentos en energía utilizable?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el componente principal de la capa de ozono que protege la Tierra de la radiación ultravioleta?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la partícula subatómica que tiene una carga negativa y orbita alrededor del núcleo de un átomo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso de cambio de estado de un sólido a un líquido debido a la absorción de calor?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el planeta más grande del sistema solar?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la fuerza que mantiene a los objetos en movimiento y que se opone al cambio en su velocidad?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es el proceso de cambio de estado de un gas a un líquido debido a la pérdida de calor?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(4, '¿Cuál es la unidad de medida utilizada para medir la cantidad de sustancia en química?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué significa la sigla "HTML" en el contexto de desarrollo web?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de las siguientes no es un lenguaje de programación orientado a objetos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "loop" o bucle?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué lenguaje de programación se utiliza comúnmente para el desarrollo de aplicaciones móviles en el sistema operativo Android?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En el contexto de programación, ¿qué es un "framework" o marco de trabajo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de los siguientes lenguajes de programación es conocido por su uso en desarrollo web en el lado del servidor?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "bug" o error de software?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de las siguientes no es una variable de tipo primitivo en programación?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué es un "IDE" en programación?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué significa la sigla "SQL" en el contexto de bases de datos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "array" o arreglo?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de las siguientes no es una plataforma de desarrollo de software?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "API"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué lenguaje de programación es comúnmente utilizado para el análisis y procesamiento de datos?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "booleano" o tipo de dato booleano?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de las siguientes no es una operación aritmética en programación?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué lenguaje de programación se utiliza comúnmente en el desarrollo de aplicaciones para iOS?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Qué es un "algoritmo" en programación?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, 'En programación, ¿qué es un "ciclo for"?', 'facil');
...
INSERT INTO pregunta(id_categoria, enunciado, dificultad)values(5, '¿Cuál de las siguientes no es una estructura de datos en programación?', 'facil');
...
INSERT INTO categoria(id,nombre,agregada,color)values(1,'Espectaculo',false,'#da6e19');
...
INSERT INTO categoria(id,nombre,agregada,color)values(5,'Programacion',false,'#da6e19');
